...
if(_chao)
{
	...
	{
		sprite_index = spr_inimigo_fantasma_run;
		image_xscale = sin(velh);
	}
	else
	{
		sprite_index = spr_inimigo_fantasma_idle;
	}
	...
	{
		//se eu não posso cair e não estou tocando no chão na minha frente, então mudo direção
		velh *= -1;
	}
	}
} 
